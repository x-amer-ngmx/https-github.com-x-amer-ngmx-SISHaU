...
namespace SISHaU.Signature
{
	...
	public class XadesSignedXml : System.Security.Cryptography.Xml.SignedXml
	{
		...
		public virtual bool CheckRevocationValuesMatchRevocationRefs()
		{
			...
			var unsignedSignatureProperties = this.XadesObject.QualifyingProperties.UnsignedProperties.UnsignedSignatureProperties;
				...
				(unsignedSignatureProperties.RevocationValues != null))
			{
				...
				foreach (CRLValue crlValue in unsignedSignatureProperties.RevocationValues.CRLValues.CRLValueCollection)
				{
					...
					var crlDigest = sha1Managed.ComputeHash(crlValue.PkiData);
	    ...
	    private HashAlgorithm _signedInfoHash;
        ...
        private void BuildDigestedReferences()
        {
            ...
            Type signedXmlType = typeof(SignedXml);
            FieldInfo SignedXml_m_refProcessed = signedXmlType.GetField("m_refProcessed", BindingFlags.NonPublic | BindingFlags.Instance);
            SignedXml_m_refProcessed.SetValue(this, new bool[references.Count]);
            //

            //this.m_refLevelCache = new int[references.Count];
            var SignedXml_m_refLevelCache = signedXmlType.GetField("m_refLevelCache", BindingFlags.NonPublic | BindingFlags.Instance);
            ...
            var System_Security_Assembly = Assembly.Load("System.Security, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a");
            ...
            var referenceLevelSortOrderReferences = ReferenceLevelSortOrder_Type.GetProperty("References", BindingFlags.Public | BindingFlags.Instance);
            referenceLevelSortOrderReferences.SetValue(comparer, references, null);
            //
            ...
            //
            FieldInfo SignedXml_m_containingDocument = signedXmlType.GetField("m_containingDocument", BindingFlags.NonPublic | BindingFlags.Instance);
